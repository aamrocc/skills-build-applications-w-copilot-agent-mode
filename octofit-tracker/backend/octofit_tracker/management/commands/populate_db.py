...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Workouts
        workouts = [
            {'name': 'Full Body', 'description': 'Full body workout', 'suggested_for': [user_ids[0], user_ids[2]]},
            {'name': 'Cardio Blast', 'description': 'Intense cardio', 'suggested_for': [user_ids[1], user_ids[3]]},
        ]
